...
function renderSightingItem(s) {
  var sAvatar = (s.user_avatar && s.user_avatar.startsWith('/')) ? '<img src="' + escHtml(s.user_avatar) + '" style="width:28px;height:28px;border-radius:50%;object-fit:cover" onerror="this.style.display=&apos;none&apos;" />' : '<img src="/uploads/avatars/default-girl.png" style="width:28px;height:28px;border-radius:50%;object-fit:cover" onerror="this.style.display=&apos;none&apos;" />';
