      ...
      el.innerHTML = wallPosts.map(p => {
        ...
        if (hasImages) {
          ...
          if (imgCount === 1) {
            ...
            imageGrid = isVid
              ? '<video src="' + url + '" controls style="width:100%;max-height:200px;border-radius:12px;margin-top:8px;background:#000" muted playsinline></video>'
              : '<img src="' + url + '" style="width:100%;max-height:200px;object-fit:cover;border-radius:12px;margin-top:8px" loading="lazy" onclick="showWallDetail('+p.id+')" />';
          } else if (imgCount === 2) {
