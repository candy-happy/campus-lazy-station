...
function renderStarCandidates() {
  ...
  _starCandidates.forEach(function(c, idx) {
    ...
    if (thumbnails.length >= 2) {
      ...
      photoArea = '<div style="aspect-ratio:1;border-radius:10px;overflow:hidden"><img src="/default-cover.png" style="width:100%;height:100%;object-fit:cover" /></div>';
    }
...
async function showStarDetail(id) {
  ...
  try {
    ...
    if (photos.length === 0) {
      photosHtml += '<div style="width:100%;height:160px;display:flex;align-items:center;justify-content:center;border-radius:12px;overflow:hidden"><img src="/default-cover.png" style="width:100%;height:100%;object-fit:cover" /></div>';
    }
    photosHtml += '</div>';
    ...
    if (userCover) {
      ...
      coverStyle = 'background:url(/default-cover.png);background-size:cover;background-position:center';
    }
  ...
  try {
    ...
    r.hall.forEach(function(item) {
      ...
      html += '<div style="background:var(--card);border-radius:16px;overflow:hidden;margin-bottom:14px;box-shadow:0 2px 12px rgba(0,0,0,0.05)">'
        ...
        + (coverImg ? '<img src="' + coverImg + '" style="width:100%;height:100%;object-fit:cover" />' : '<img src="/default-cover.png" style="width:100%;height:100%;object-fit:cover" />')
